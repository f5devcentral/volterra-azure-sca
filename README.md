...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_azure"></a> [azure](#module\_azure) | ./azure |  |
| <a name="module_volterra"></a> [volterra](#module\_volterra) | ./volterra |  |
...
| <a name="input_sshPublicKeyPath"></a> [sshPublicKeyPath](#input\_sshPublicKeyPath) | OPTIONAL: ssh public key path for instances | `string` | `"~/.ssh/id_rsa.pub"` |
| <a name="input_api_p12_file"></a> [api\_p12\_file](#input\_api\_p12\_file) | REQUIRED:  This is the path to the Volterra API Key.  See https://volterra.io/docs/how-to/user-mgmt/credentials | `string` | `"/Users/mcoleman/Documents/GitHub/volterra-azure-sca/creds/f5-sa.console.ves.volterra.io.api-creds.p12"` |
...
| <a name="input_url"></a> [url](#input\_url) | REQUIRED:  This is your Volterra Namespace | `string` | `"https://playground.console.ves.volterra.io/api"` |
...
| Name | Description |
|------|-------------|
| <a name="output_volterra"></a> [volterra](#output\_volterra) | n/a |
